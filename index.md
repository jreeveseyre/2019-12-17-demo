...
venue: "FIXME"        # CLIR (e.g., "Euphoric State University")
address: "FIXME"      # Address, Address (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "FIXME"      # us (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
